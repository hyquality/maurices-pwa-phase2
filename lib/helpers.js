...
export function getCartItemPrice(item) {
    let main = item.originalPrice
    if (item.originalPrice !== item.purchasePrice) {
            ...
            variants.push(
                {
                    ...
                    image: {
                        main: parseImageUrl(color.productImageUrl),
                        hover: parseImageUrl(color.alternateImageUrl?color.alternateImageUrl:color.productImageUrl)
                    },
                    gallery: [
                        {
                            image: parseImageUrl(color.productImageUrl),
